...
const Hero = ({ setCurrentPage }) => {
  ...
  return (
    <section className="bg-white py-20 border-b-2 border-black">
      ...
      {showModal && <TestDriveModal onClose={() => setShowModal(false)} />}
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="bg-black text-white px-8 py-4 text-lg font-medium hover:bg-gray-800 transition"
              >
                Browse Inventory
              </button>
              ...
              <button 
                ...
                className="bg-white text-black border-2 border-black px-8 py-4 text-lg font-medium hover:bg-gray-50 transition"
              >
                Schedule Test Drive
              </button>
            </div>
